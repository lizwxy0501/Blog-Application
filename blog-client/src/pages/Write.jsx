...
const Write = () => {
  ...
  //check whether it's a new post or an existing post
    ...
    <div className='add'>
      ...
      <div className="menu">
        ...
        <div className="item">
          ...
          <div className="cat">
          <input type="radio" checked={cat === "tech"} name='cat' value='technology' id='technology' onChange={(e)=>setCat(e.target.value)}/>
